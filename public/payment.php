...
<head>
    ...
    <script>Mercadopago.setPublishableKey("TEST-8eb3aa1d-af27-480d-b16a-c4e1d42132ee");</script> <!-- insira aqui sua public key -->
</head>
<body>

<h1>Checkout transparente mercadopago</h1>

<form action="credencialesMP.php" method="post" id="pay" name="pay" >
    <fieldset>
        <ul>
            <li>
